 ...
 * 읽기전용 동기화하며, growlio의 진행률과는 서로 다른 데이터 소스임). */
export default function AnnualSavingsGoalCard() {
  ...
  return (
    <div className="card space-y-3">
      <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">연간 저축목표</h3>
      ...
      {goalOfYear && Number(goalOfYear.target_amount_krw) > 0 && (
        <div className="pt-3 border-t border-gray-100 dark:border-gray-800 space-y-3">
          ...
          {goalOfYear.monthly_achievement_pct !== null && (
            <div className="space-y-1">
              <div className="flex items-center justify-between text-xs">
